        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-gray-900 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto border border-gray-700 shadow-2xl">
            ...
            <form onSubmit={handleCreateProduct} className="p-6 space-y-4">
              ...
              <div><label className="block text-sm font-medium mb-2 text-gray-300">Тип ChatGPT</label><select name="gptType" defaultValue={editingProduct?.gptType || ''} style={{ display: editingProduct?.type === 'chatgpt_token' ? 'block' : 'none' }} className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white"><option value="">Выберите тип...</option><option value="plus_1m">ChatGPT Plus 1 месяц</option><option value="plus_12m">ChatGPT Plus 12 месяцев</option><option value="pro_x20_1m">ChatGPT Pro X20 1 месяц</option><option value="pro_x5_1m">ChatGPT Pro X5 1 месяц</option><option value="go_12m">ChatGPT GO 12 месяцев</option></select></div>
