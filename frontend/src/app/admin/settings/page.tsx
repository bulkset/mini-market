...
import { 
  LayoutDashboard, Package, Tag, Key, BarChart3, Settings, LogOut, Menu, X, Loader2, Save, FileText
} from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-700">
                ...
                <div className="grid gap-4">
                  ...
                  <div><label className="block text-sm font-medium mb-2 text-gray-300">Email для уведомлений</label><input type="email" value={formData.notification_email || ''} onChange={(e) => setFormData({ ...formData, notification_email: e.target.value })} className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white" /></div>
                </div>
              </div>
